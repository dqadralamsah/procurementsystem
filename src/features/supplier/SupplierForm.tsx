...
export default function SupplierForm({ initialData, isOpen, onOpenChange }: Props) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          <DialogTitle>{initialData ? 'Edit Supplier' : 'Create New Supplier'}</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4">
          ...
          <div className="space-y-1">
            ...
            <input {...form.register('email')} className="w-full p-2 border rounded" />
          ...
          <div className="space-y-1">
            ...
            <input {...form.register('contact')} className="w-full p-2 border rounded" />
            {form.formState.errors.contact && (
              <p className="text-red-500 text-xs">{form.formState.errors.contact.message}</p>
            )}
          </div>
